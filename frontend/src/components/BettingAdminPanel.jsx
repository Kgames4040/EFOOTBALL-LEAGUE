...
const ODDS_LABELS = {
  ...
  goal_over_1_5: "Üst 1.5", goal_under_1_5: "Alt 1.5",
  goal_over_2_5: "Üst 2.5", goal_under_2_5: "Alt 2.5",
  goal_over_3_5: "Üst 3.5", goal_under_3_5: "Alt 3.5",
  goal_over_4_5: "Üst 4.5", goal_under_4_5: "Alt 4.5",
  home_goal_over_0_5: "Ev 0.5 Üst", home_goal_under_0_5: "Ev 0.5 Alt",
  home_goal_over_1_5: "Ev 1.5 Üst", home_goal_under_1_5: "Ev 1.5 Alt",
  home_goal_over_2_5: "Ev 2.5 Üst", home_goal_under_2_5: "Ev 2.5 Alt",
  home_goal_over_3_5: "Ev 3.5 Üst", home_goal_under_3_5: "Ev 3.5 Alt",
  away_goal_over_0_5: "Dep 0.5 Üst", away_goal_under_0_5: "Dep 0.5 Alt",
  away_goal_over_1_5: "Dep 1.5 Üst", away_goal_under_1_5: "Dep 1.5 Alt",
  away_goal_over_2_5: "Dep 2.5 Üst", away_goal_under_2_5: "Dep 2.5 Alt",
  away_goal_over_3_5: "Dep 3.5 Üst", away_goal_under_3_5: "Dep 3.5 Alt",
  corner_over_7_5: "K.Üst 7.5", corner_under_7_5: "K.Alt 7.5",
  corner_over_8_5: "K.Üst 8.5", corner_under_8_5: "K.Alt 8.5",
  corner_over_9_5: "K.Üst 9.5", corner_under_9_5: "K.Alt 9.5",
  corner_over_10_5: "K.Üst 10.5", corner_under_10_5: "K.Alt 10.5",
};
      ...
      <div className="max-h-64 overflow-y-auto pr-1 mb-3">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
          {Object.keys(ODDS_LABELS).map((k) => {
            const locked = !!match.bet_locks?.[k];
            return (
            <div key={k} className="relative">
              <div className="flex justify-between items-center text-[10px] text-[color:var(--btg-muted)] font-bold uppercase mb-0.5">
                <span>{ODDS_LABELS[k]}</span>
                <button type="button" onClick={async () => {
                  try {
                    await toggleBetLock(match.id, k, !locked);
                    toast.success(!locked ? `${ODDS_LABELS[k]} kilitlendi` : `${ODDS_LABELS[k]} açıldı`);
                    onDone?.();
                  } catch (e) { toast.error(e?.response?.data?.detail || "Hata"); }
                }} className={locked ? "text-red-400" : "text-green-400"}>
