...
import { BET_TYPE_LABEL, SELECTION_LABEL, SELECTION_SHORT, getOdd, getWallet, createCoupon, MIN_STAKE, isLocked } from "../lib/betting";
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="odds-grid-3">
              <OddButton label="1" odd={getOdd(odds, "MS", "1")} active={isSelected(match.id, "MS", "1")} disabled={isLocked(locks, "MS", "1")} onClick={() => onSelect(match, "MS", "1")} />
              <OddButton label="X" odd={getOdd(odds, "MS", "X")} active={isSelected(match.id, "MS", "X")} disabled={isLocked(locks, "MS", "X")} onClick={() => onSelect(match, "MS", "X")} />
              <OddButton label="2" odd={getOdd(odds, "MS", "2")} active={isSelected(match.id, "MS", "2")} disabled={isLocked(locks, "MS", "2")} onClick={() => onSelect(match, "MS", "2")} />
            </div>
          </div>

          <div>
            <div className="text-[10px] uppercase tracking-wider text-[color:var(--btg-muted)] mb-1 font-bold">Maç Gol Alt / Üst</div>
            <div className="grid grid-cols-2 gap-2">
              <div className="space-y-1">
                <OddButton label="Üst 1.5" odd={getOdd(odds, "GOAL_O_U", "OVER_1_5")} active={isSelected(match.id, "GOAL_O_U", "OVER_1_5")} disabled={isLocked(locks, "GOAL_O_U", "OVER_1_5")} onClick={() => onSelect(match, "GOAL_O_U", "OVER_1_5")} />
                <OddButton label="Üst 2.5" odd={getOdd(odds, "GOAL_O_U", "OVER_2_5")} active={isSelected(match.id, "GOAL_O_U", "OVER_2_5")} disabled={isLocked(locks, "GOAL_O_U", "OVER_2_5")} onClick={() => onSelect(match, "GOAL_O_U", "OVER_2_5")} />
                <OddButton label="Üst 3.5" odd={getOdd(odds, "GOAL_O_U", "OVER_3_5")} active={isSelected(match.id, "GOAL_O_U", "OVER_3_5")} disabled={isLocked(locks, "GOAL_O_U", "OVER_3_5")} onClick={() => onSelect(match, "GOAL_O_U", "OVER_3_5")} />
                <OddButton label="Üst 4.5" odd={getOdd(odds, "GOAL_O_U", "OVER_4_5")} active={isSelected(match.id, "GOAL_O_U", "OVER_4_5")} disabled={isLocked(locks, "GOAL_O_U", "OVER_4_5")} onClick={() => onSelect(match, "GOAL_O_U", "OVER_4_5")} />
              </div>
              <div className="space-y-1">
                <OddButton label="Alt 1.5" odd={getOdd(odds, "GOAL_O_U", "UNDER_1_5")} active={isSelected(match.id, "GOAL_O_U", "UNDER_1_5")} disabled={isLocked(locks, "GOAL_O_U", "UNDER_1_5")} onClick={() => onSelect(match, "GOAL_O_U", "UNDER_1_5")} />
                <OddButton label="Alt 2.5" odd={getOdd(odds, "GOAL_O_U", "UNDER_2_5")} active={isSelected(match.id, "GOAL_O_U", "UNDER_2_5")} disabled={isLocked(locks, "GOAL_O_U", "UNDER_2_5")} onClick={() => onSelect(match, "GOAL_O_U", "UNDER_2_5")} />
                <OddButton label="Alt 3.5" odd={getOdd(odds, "GOAL_O_U", "UNDER_3_5")} active={isSelected(match.id, "GOAL_O_U", "UNDER_3_5")} disabled={isLocked(locks, "GOAL_O_U", "UNDER_3_5")} onClick={() => onSelect(match, "GOAL_O_U", "UNDER_3_5")} />
                <OddButton label="Alt 4.5" odd={getOdd(odds, "GOAL_O_U", "UNDER_4_5")} active={isSelected(match.id, "GOAL_O_U", "UNDER_4_5")} disabled={isLocked(locks, "GOAL_O_U", "UNDER_4_5")} onClick={() => onSelect(match, "GOAL_O_U", "UNDER_4_5")} />
              </div>
            </div>
          </div>

          <div>
            <div className="text-[10px] uppercase tracking-wider text-[color:var(--btg-muted)] mb-1 font-bold">Ev Sahibi Gol Alt / Üst</div>
            <div className="grid grid-cols-2 gap-2">
              <div className="space-y-1">
                <OddButton label="Ev Üst 0.5" odd={getOdd(odds, "TEAM_GOAL_O_U", "HOME_OVER_0_5")} active={isSelected(match.id, "TEAM_GOAL_O_U", "HOME_OVER_0_5")} disabled={isLocked(locks, "TEAM_GOAL_O_U", "HOME_OVER_0_5")} onClick={() => onSelect(match, "TEAM_GOAL_O_U", "HOME_OVER_0_5")} />
                <OddButton label="Ev Üst 1.5" odd={getOdd(odds, "TEAM_GOAL_O_U", "HOME_OVER_1_5")} active={isSelected(match.id, "TEAM_GOAL_O_U", "HOME_OVER_1_5")} disabled={isLocked(locks, "TEAM_GOAL_O_U", "HOME_OVER_1_5")} onClick={() => onSelect(match, "TEAM_GOAL_O_U", "HOME_OVER_1_5")} />
                <OddButton label="Ev Üst 2.5" odd={getOdd(odds, "TEAM_GOAL_O_U", "HOME_OVER_2_5")} active={isSelected(match.id, "TEAM_GOAL_O_U", "HOME_OVER_2_5")} disabled={isLocked(locks, "TEAM_GOAL_O_U", "HOME_OVER_2_5")} onClick={() => onSelect(match, "TEAM_GOAL_O_U", "HOME_OVER_2_5")} />
                <OddButton label="Ev Üst 3.5" odd={getOdd(odds, "TEAM_GOAL_O_U", "HOME_OVER_3_5")} active={isSelected(match.id, "TEAM_GOAL_O_U", "HOME_OVER_3_5")} disabled={isLocked(locks, "TEAM_GOAL_O_U", "HOME_OVER_3_5")} onClick={() => onSelect(match, "TEAM_GOAL_O_U", "HOME_OVER_3_5")} />
              </div>
              <div className="space-y-1">
                <OddButton label="Ev Alt 0.5" odd={getOdd(odds, "TEAM_GOAL_O_U", "HOME_UNDER_0_5")} active={isSelected(match.id, "TEAM_GOAL_O_U", "HOME_UNDER_0_5")} disabled={isLocked(locks, "TEAM_GOAL_O_U", "HOME_UNDER_0_5")} onClick={() => onSelect(match, "TEAM_GOAL_O_U", "HOME_UNDER_0_5")} />
                <OddButton label="Ev Alt 1.5" odd={getOdd(odds, "TEAM_GOAL_O_U", "HOME_UNDER_1_5")} active={isSelected(match.id, "TEAM_GOAL_O_U", "HOME_UNDER_1_5")} disabled={isLocked(locks, "TEAM_GOAL_O_U", "HOME_UNDER_1_5")} onClick={() => onSelect(match, "TEAM_GOAL_O_U", "HOME_UNDER_1_5")} />
                <OddButton label="Ev Alt 2.5" odd={getOdd(odds, "TEAM_GOAL_O_U", "HOME_UNDER_2_5")} active={isSelected(match.id, "TEAM_GOAL_O_U", "HOME_UNDER_2_5")} disabled={isLocked(locks, "TEAM_GOAL_O_U", "HOME_UNDER_2_5")} onClick={() => onSelect(match, "TEAM_GOAL_O_U", "HOME_UNDER_2_5")} />
                <OddButton label="Ev Alt 3.5" odd={getOdd(odds, "TEAM_GOAL_O_U", "HOME_UNDER_3_5")} active={isSelected(match.id, "TEAM_GOAL_O_U", "HOME_UNDER_3_5")} disabled={isLocked(locks, "TEAM_GOAL_O_U", "HOME_UNDER_3_5")} onClick={() => onSelect(match, "TEAM_GOAL_O_U", "HOME_UNDER_3_5")} />
              </div>
            </div>
          </div>

          <div>
            <div className="text-[10px] uppercase tracking-wider text-[color:var(--btg-muted)] mb-1 font-bold">Deplasman Gol Alt / Üst</div>
            <div className="grid grid-cols-2 gap-2">
              <div className="space-y-1">
                <OddButton label="Dep Üst 0.5" odd={getOdd(odds, "TEAM_GOAL_O_U", "AWAY_OVER_0_5")} active={isSelected(match.id, "TEAM_GOAL_O_U", "AWAY_OVER_0_5")} disabled={isLocked(locks, "TEAM_GOAL_O_U", "AWAY_OVER_0_5")} onClick={() => onSelect(match, "TEAM_GOAL_O_U", "AWAY_OVER_0_5")} />
                <OddButton label="Dep Üst 1.5" odd={getOdd(odds, "TEAM_GOAL_O_U", "AWAY_OVER_1_5")} active={isSelected(match.id, "TEAM_GOAL_O_U", "AWAY_OVER_1_5")} disabled={isLocked(locks, "TEAM_GOAL_O_U", "AWAY_OVER_1_5")} onClick={() => onSelect(match, "TEAM_GOAL_O_U", "AWAY_OVER_1_5")} />
                <OddButton label="Dep Üst 2.5" odd={getOdd(odds, "TEAM_GOAL_O_U", "AWAY_OVER_2_5")} active={isSelected(match.id, "TEAM_GOAL_O_U", "AWAY_OVER_2_5")} disabled={isLocked(locks, "TEAM_GOAL_O_U", "AWAY_OVER_2_5")} onClick={() => onSelect(match, "TEAM_GOAL_O_U", "AWAY_OVER_2_5")} />
                <OddButton label="Dep Üst 3.5" odd={getOdd(odds, "TEAM_GOAL_O_U", "AWAY_OVER_3_5")} active={isSelected(match.id, "TEAM_GOAL_O_U", "AWAY_OVER_3_5")} disabled={isLocked(locks, "TEAM_GOAL_O_U", "AWAY_OVER_3_5")} onClick={() => onSelect(match, "TEAM_GOAL_O_U", "AWAY_OVER_3_5")} />
              </div>
              <div className="space-y-1">
                <OddButton label="Dep Alt 0.5" odd={getOdd(odds, "TEAM_GOAL_O_U", "AWAY_UNDER_0_5")} active={isSelected(match.id, "TEAM_GOAL_O_U", "AWAY_UNDER_0_5")} disabled={isLocked(locks, "TEAM_GOAL_O_U", "AWAY_UNDER_0_5")} onClick={() => onSelect(match, "TEAM_GOAL_O_U", "AWAY_UNDER_0_5")} />
                <OddButton label="Dep Alt 1.5" odd={getOdd(odds, "TEAM_GOAL_O_U", "AWAY_UNDER_1_5")} active={isSelected(match.id, "TEAM_GOAL_O_U", "AWAY_UNDER_1_5")} disabled={isLocked(locks, "TEAM_GOAL_O_U", "AWAY_UNDER_1_5")} onClick={() => onSelect(match, "TEAM_GOAL_O_U", "AWAY_UNDER_1_5")} />
                <OddButton label="Dep Alt 2.5" odd={getOdd(odds, "TEAM_GOAL_O_U", "AWAY_UNDER_2_5")} active={isSelected(match.id, "TEAM_GOAL_O_U", "AWAY_UNDER_2_5")} disabled={isLocked(locks, "TEAM_GOAL_O_U", "AWAY_UNDER_2_5")} onClick={() => onSelect(match, "TEAM_GOAL_O_U", "AWAY_UNDER_2_5")} />
                <OddButton label="Dep Alt 3.5" odd={getOdd(odds, "TEAM_GOAL_O_U", "AWAY_UNDER_3_5")} active={isSelected(match.id, "TEAM_GOAL_O_U", "AWAY_UNDER_3_5")} disabled={isLocked(locks, "TEAM_GOAL_O_U", "AWAY_UNDER_3_5")} onClick={() => onSelect(match, "TEAM_GOAL_O_U", "AWAY_UNDER_3_5")} />
              </div>
            </div>
          </div>

          <div>
            <div className="text-[10px] uppercase tracking-wider text-[color:var(--btg-muted)] mb-1 font-bold">Korner Alt / Üst</div>
            <div className="grid grid-cols-2 gap-2">
              <div className="space-y-1">
                <OddButton label="K.Üst 7.5" odd={getOdd(odds, "CORNER_O_U", "OVER_7_5")} active={isSelected(match.id, "CORNER_O_U", "OVER_7_5")} disabled={isLocked(locks, "CORNER_O_U", "OVER_7_5")} onClick={() => onSelect(match, "CORNER_O_U", "OVER_7_5")} />
                <OddButton label="K.Üst 8.5" odd={getOdd(odds, "CORNER_O_U", "OVER_8_5")} active={isSelected(match.id, "CORNER_O_U", "OVER_8_5")} disabled={isLocked(locks, "CORNER_O_U", "OVER_8_5")} onClick={() => onSelect(match, "CORNER_O_U", "OVER_8_5")} />
                <OddButton label="K.Üst 9.5" odd={getOdd(odds, "CORNER_O_U", "OVER_9_5")} active={isSelected(match.id, "CORNER_O_U", "OVER_9_5")} disabled={isLocked(locks, "CORNER_O_U", "OVER_9_5")} onClick={() => onSelect(match, "CORNER_O_U", "OVER_9_5")} />
                <OddButton label="K.Üst 10.5" odd={getOdd(odds, "CORNER_O_U", "OVER_10_5")} active={isSelected(match.id, "CORNER_O_U", "OVER_10_5")} disabled={isLocked(locks, "CORNER_O_U", "OVER_10_5")} onClick={() => onSelect(match, "CORNER_O_U", "OVER_10_5")} />
              </div>
              <div className="space-y-1">
                <OddButton label="K.Alt 7.5" odd={getOdd(odds, "CORNER_O_U", "UNDER_7_5")} active={isSelected(match.id, "CORNER_O_U", "UNDER_7_5")} disabled={isLocked(locks, "CORNER_O_U", "UNDER_7_5")} onClick={() => onSelect(match, "CORNER_O_U", "UNDER_7_5")} />
                <OddButton label="K.Alt 8.5" odd={getOdd(odds, "CORNER_O_U", "UNDER_8_5")} active={isSelected(match.id, "CORNER_O_U", "UNDER_8_5")} disabled={isLocked(locks, "CORNER_O_U", "UNDER_8_5")} onClick={() => onSelect(match, "CORNER_O_U", "UNDER_8_5")} />
                <OddButton label="K.Alt 9.5" odd={getOdd(odds, "CORNER_O_U", "UNDER_9_5")} active={isSelected(match.id, "CORNER_O_U", "UNDER_9_5")} disabled={isLocked(locks, "CORNER_O_U", "UNDER_9_5")} onClick={() => onSelect(match, "CORNER_O_U", "UNDER_9_5")} />
                <OddButton label="K.Alt 10.5" odd={getOdd(odds, "CORNER_O_U", "UNDER_10_5")} active={isSelected(match.id, "CORNER_O_U", "UNDER_10_5")} disabled={isLocked(locks, "CORNER_O_U", "UNDER_10_5")} onClick={() => onSelect(match, "CORNER_O_U", "UNDER_10_5")} />
              </div>
            </div>
          </div>
